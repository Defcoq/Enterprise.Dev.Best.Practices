<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EA.DAL.ORM.Library.UI.Web.Default" %>
...
<body>
    ...
    <p>
        ...
        <asp:Repeater ID="rptMembers" runat="server">
            ...
            <ItemTemplate>
                    <li><%# Eval("FullName")%> (<a href="MemberDetails.aspx?Id=<%# Eval("MemberId")%>">view details</a>)</li> 
            </ItemTemplate>
            <FooterTemplate>
                </ul>
            </FooterTemplate> 
